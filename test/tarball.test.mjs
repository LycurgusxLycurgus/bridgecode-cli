...
test("exact packed artifact: allowlist, install, update, doctor and no writes on dry-run",async t=>{
 ...
 for(const p of [...MANAGED_PATHS,"package.json","bin/bridgecode.mjs","hooks/bridgecode-turn.mjs","legacy/4.1.0.json","legacy/4.3.0.json","legacy/4.3.1.json"])assert.ok(names.includes(p),p);
